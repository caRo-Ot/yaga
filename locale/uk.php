...
// Misc
$Definition['1 year'] = '1 рік';
$Definition['3 months'] = '3 місяці';
$Definition['5 years'] = '5 років';
$Definition['6 months'] = '6 місяців';
$Definition['Auto Award'] = 'Автонагорода';
$Definition['Automatically Award'] = 'Автоматична нагорода';
$Definition['Award Value'] = 'Ціна нагороди';
$Definition['Css Class'] = 'Css Class';
$Definition['Days'] = 'Дні';
$Definition['Description'] = 'Опис';
$Definition['Export'] = 'Експорт';
$Definition['Grant'] = 'Дар';
$Definition['Icon'] = 'Іконка';
$Definition['Image Files'] = 'Файли зображень';
$Definition['Image'] = 'Зображення';
$Definition['Less than:'] = 'Менше ніж:';
$Definition['More than or:'] = 'Більше або:';
$Definition['More than:'] = 'Більше ніж:';
$Definition['Photo'] = 'Фото';
$Definition['Rule'] = 'Правило';
$Definition['Time Frame'] = 'Період часу';
$Definition['Tooltip'] = 'Підказка';
$Definition['Weeks'] = 'Тижні';
$Definition['Yaga.Settings'] = 'Налаштування Yaga';
$Definition['Years'] = 'Роки';
$Definition['Yaga.MenuLinks.Show'] = 'Показати посилання в головному меню, що описують вашу конфігурацію Yaga';

// Actions
$Definition['Yaga.Action'] = 'Дія';
$Definition['Yaga.Action.Add'] = 'Додати дію';
$Definition['Yaga.Action.Added'] = 'Дія успішно додана!';
$Definition['Yaga.Action.Delete'] = 'Видалити Дію';
$Definition['Yaga.Action.Edit'] = 'Редагувати Дію';
$Definition['Yaga.Action.Invalid'] = 'Неприпустима Дія';
$Definition['Yaga.Action.InvalidTargetID'] = 'Неприпустимий ID';
$Definition['Yaga.Action.InvalidTargetType'] = 'Неприпустима ціль Реації';
$Definition['Yaga.Action.Move'] = 'Перемістити %s реакцій?';
$Definition['Yaga.Action.PermDesc'] = "Користувачеві знадобиться наступний дозвіл на використання цієї дії. Типовим є 'Yaga.Reactions.Add'.";
$Definition['Yaga.ActionUpdated'] = 'Дія успішно оновлена!';
$Definition['Yaga.Actions.Current'] = 'Поточні Дії';
$Definition['Yaga.Actions.Desc'] = "Дії відображаються під створеним користувачем вмістом, таким як обговорення, коментарі та елементи активності. Інші користувачі можуть вибрати його як "реакцію". Власник оригінального предмета отримає бали, ґрунтуючись на реакціях інших. Це формує позитивний цикл зворотного зв'язку, як для позитивних, <em> так і </em> негативних дій.";
$Definition['Yaga.Actions.Manage'] = 'Керувати Діями';
$Definition['Yaga.Actions.Settings.Desc'] = 'Тут ви можете керувати доступними діями, які можна використовувати як реакції. Перетягніть елементи, щоб упорядкувати їх порядок відображення.';
$Definition['Yaga.Reactions'] = 'Реакції';
$Definition['Yaga.Reactions.RecordFormat'] = '%s - %s на %s.';
$Definition['Yaga.Reactions.RecordLimit.Plural'] = 'і %s інших.';
$Definition['Yaga.Reactions.RecordLimit.Single'] = 'і %s інших.';
$Definition['Yaga.Reactions.Use'] = 'Використовуйте Реації';

// Badges
$Definition['Yaga.Badge'] = 'Нагорода';
$Definition['Yaga.Badge.Add'] = 'Додати Нагороду';
$Definition['Yaga.Badge.Added'] = 'Нагороду додано успішно!';
$Definition['Yaga.Badge.AlreadyAwarded'] = '%s вже має цю нагороду!';
$Definition['Yaga.Badge.Award'] = 'Подарувати Нагороду';
$Definition['Yaga.Badge.Delete'] = 'Видалити Нагороду';
$Definition['Yaga.Badge.DetailLink'] = 'Переглянути статистику про цю Нагороду';
$Definition['Yaga.Badge.Earned'] = 'Ви заслужили цю Нагороду';
